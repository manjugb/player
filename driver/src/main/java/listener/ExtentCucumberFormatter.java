...
public class ExtentCucumberFormatter implements Reporter, Formatter {
	...
	protected final static String report_path = ".//ExtentReport//TheoTest_" + dateTime + ".html";
	//public static String dateTime = new SimpleDateFormat("yyyyMMdd-hha").format(new Date());
    ...
    public ExtentCucumberFormatter(File filePath) {
        if (!filePath.getPath().equals("")) {
            ...
            String reportDir = "ExtentReport/IntegrationTest_" + System.currentTimeMillis();
            this.htmlReportDir = new File(reportDir);
            this.extent = new ExtentReports(reportDir + "/Theo Player TestReport.html");
        }
    }
    ...
    public static void initiateExtentCucumberFormatter() {
        String reportFilePath = report_path;
        		//"output" + File.separator + "Run_" + System.currentTimeMillis() + File.separator +  "report.html";
      //String report_path = ".//ExtentReport//IntegrationTest_" + dateTime + ".html";
    ...
    public static void logInfo(File configFile) {
        extent.loadConfig(configFile);
    }
